...
/**
 * We need to add Allure report dependency in pom.xml
 * Allure report dependency is slightly different from other dependencies
 * To Generate report in Allure --> Open CMD --> navigate to project --> allure serve allure-results
 * @author Sumit.Saha
 *
 */
