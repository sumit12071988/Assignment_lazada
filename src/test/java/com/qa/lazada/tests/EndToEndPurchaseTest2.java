...
public class EndToEndPurchaseTest2 {
	...
	public void verifyLoginPageTitleTest() throws InterruptedException {
		...
		String title1 = profilePage.getProfilePageTitle();
		System.out.println("Profile Page title is: "+ title);
		Assert.assertEquals(title1,Constants.PROFILE_PAGE_TITLE);
		
		homePage = profilePage.goToHomePage();
		
		String title2 = homePage.getHomePageTitle();
		System.out.println("HomePage title is: " + title);
		Assert.assertEquals(title2,Constants.HOME_PAGE_TITLE);
		
		productPage = homePage.goToSelectedProductPage();
		
		String title3 = productPage.getProductPageTitle();
		System.out.println("ProductPage title is: " + title);
		Assert.assertEquals(title3,Constants.PRODUCT_PAGE_TITLE);
		
		checkoutPage = productPage.goToCheckOutPage();
		
		String title4 = checkoutPage.getCheckoutPageTitle();
		System.out.println("CheckOutPage title is: " + title);
		Assert.assertEquals(title4,Constants.CHECKOUT_PAGE_TITLE);
	}
